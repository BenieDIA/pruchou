...
function goTo(i){
  ...
  document.querySelectorAll('.cdot')[cur]
    .classList.remove('on');

  cthumbs.children[cur]
    ...
    .map((_,j)=>
      `<div class="pl-b"
        style="
          ...
          animation-delay:${i*0.12+j*0.09}s">
      </div>`
    ).join('');

  el.innerHTML=`

    <div class="pl-thumb" style="background:${s.bg}30">
      ${s.ico}
    </div>
